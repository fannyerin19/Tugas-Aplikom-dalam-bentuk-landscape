...
\]
\end{eulerformula}
\eulerimg{0}{images/Pekan 1-2_Fanny Erina Dewi_22305141005_EMT00-FisrtSteps_Aplikom-008-large.png}
\begin{eulerprompt}
>$&solve(a*x^2+b*x+c,x) // rumus abc
\end{eulerprompt}
\begin{eulerformula}
...
\]
\end{eulerformula}
\eulerimg{0}{images/Pekan 1-2_Fanny Erina Dewi_22305141005_EMT00-FisrtSteps_Aplikom-011-large.png}
...
\]
\end{eulerformula}
\eulerimg{1}{images/Pekan 1-2_Fanny Erina Dewi_22305141005_EMT00-FisrtSteps_Aplikom-013-large.png}
\begin{eulerprompt}
...
\begin{eulerformula}
\[
\frac{\frac{1}{2}-\frac{\sqrt{3}\,i}{2}}{\left(\frac{\sqrt{29}}{2}-  \frac{5}{2}\right)^{\frac{1}{3}}}+\left(\frac{\sqrt{29}}{2}-\frac{5  }{2}\right)^{\frac{1}{3}}\,\left(-\frac{\sqrt{3}\,i}{2}-\frac{1}{2}  \right)+1
\]
\end{eulerformula}
\eulerimg{3}{images/Pekan 1-2_Fanny Erina Dewi_22305141005_EMT00-FisrtSteps_Aplikom-016-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/Pekan 1-2_Fanny Erina Dewi_22305141005_EMT00-FisrtSteps_Aplikom-018-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{1}{images/Pekan 1-2_Fanny Erina Dewi_22305141005_EMT00-FisrtSteps_Aplikom-020-large.png}
\end{eulernotebook}
\end{document}
